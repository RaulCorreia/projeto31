...
public class Process1 implements MyCallBack2{
    ...
    private String assinatura = "process1";
    private Scanner teclado;
	
	public Process1() throws IOException {
...
//	                	}
	                	...
	                	if("respSem".equalsIgnoreCase(teste[0])) {
                			...
                			if(teste[1].equalsIgnoreCase("4")) {
	                			...
	                			System.out.println("Processo de id: " + split[1] + " respondeu: " + teste[1]);
	                			System.out.println("Aparentemente o processo esta com problemas, sera removido do grupo");
